<template>
  <div>
    ...
    >
      ...
      <el-form-item label="店铺特点" class="switch_box">
        <span>
          <i>品牌保证</i>
          <el-switch v-model="flag.pinpai" active-color="rgb(77,0,8)" inactive-color="rgb(30,30,30)"></el-switch>
        </span>
        <span>
          <i>蜂鸟专送</i>
          <el-switch
            v-model="flag.zhuansong"
      ...
      <el-form-item label="配送费" required>
        <el-input-number v-model="money.peisongjia" :min="1" :max="15" label="配送费"></el-input-number>
      </el-form-item>
      <el-form-item label="起送价" required>
        <el-input-number v-model="money.qisongjia" :min="1" label="起送价"></el-input-number>
      </el-form-item>
  ...
  <img v-if="shopimg.imageUrl1" :src="shopimg.imageUrl1" class="avatar">
  ...
  :before-upload="beforeAvatarUpload">
  <img v-if="shopimg.imageUrl2" :src="shopimg.imageUrl2" class="avatar">
  <i v-else class="el-icon-plus avatar-uploader-icon"></i>
</el-upload>
      </el-form-item>
  ...
  :before-upload="beforeAvatarUpload">
  <img v-if="shopimg.imageUrl3" :src="shopimg.imageUrl3" class="avatar">
  <i v-else class="el-icon-plus avatar-uploader-icon"></i>
</el-upload>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  methods: {
    add(){
        this.$store.dispatch('add',{...this.ruleForm,...this.flag,...this.money,...this.time,...this.shopimg,value:this.value})
        },
    submitForm(formName) {
